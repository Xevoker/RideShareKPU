...
<head>
  ...
  <title>Edit Profile - Light Theme</title>
  <link rel="stylesheet" href="../CSS/update.css" />
</head>
<body>
  <aside class="sidebar">
    <div class="logo-container">
      <img src="../images/a.jpg" alt="Logo" class="logo-img" />
      <h2>My<span>App</span></h2>
    </div>
    <nav>
      <ul>
  ...
  <main class="main-content">
    ...
    <section class="update-info-form">
      <form>
        ...
        <div class="form-group">
          ...
          <input type="text" id="car-make" name="car-make" placeholder="e.g., Toyota, Honda" />
        </div>

        <div class="form-group">
          <label for="car-model">Car Model</label>
          <input type="text" id="car-model" name="car-model" placeholder="e.g., Corolla, Civic" />
        </div>
